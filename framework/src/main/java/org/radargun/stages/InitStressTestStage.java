...
import org.radargun.stressors.InitStressTestStressor;
...
public class InitStressTestStage extends AbstractDistStage {
   ...
   protected Map<String, Object> doWork() {
      ...
      InitStressTestStressor stressor = null;
      if (cacheSpecificKeyGenerator) {
         throw new UnsupportedOperationException();
      } else {
         stressor = new InitStressTestStressor();
      }
...
//   protected void setupStatistics(InitStressTestStressor stressor) {
//      if (generateHistogramRange) {
