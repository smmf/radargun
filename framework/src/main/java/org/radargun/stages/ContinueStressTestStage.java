...
import org.radargun.stressors.ContinueStressTestStressor;
...
public class ContinueStressTestStage extends AbstractDistStage {
   ...
   protected Map<String, Object> doWork() {
      ...
      ContinueStressTestStressor stressor = null;
      if (cacheSpecificKeyGenerator) {
         throw new UnsupportedOperationException();
//         stressor = new CacheSpecificKeyGenStressor();
      } else {
         stressor = new ContinueStressTestStressor();
      }
   ...
   protected void setupStatistics(ContinueStressTestStressor stressor) {
      if (generateHistogramRange) {
