...
import pt.ist.fenixframework.backend.jvstm.datagrid.JvstmDataGridBackEnd;
...
public class FFWrapper implements CacheWrapper {

    private static final Logger logger = LoggerFactory.getLogger(FFWrapper.class);
    ...
    protected static JvstmDataGridBackEnd backEnd;
    ...
    public void setUp(String config, boolean isLocal, int nodeIndex, TypedProperties confAttributes) throws Exception {
        ...
        backEnd = JvstmDataGridBackEnd.getInstance();
    }
...
//        }
    ...
    public String getInfo() {
        return "FFWrapper using " + this.info;
    }
